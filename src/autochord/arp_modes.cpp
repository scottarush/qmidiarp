...
static const mode_chords_t mode_group_chord_table[NUM_MODE_GROUPS][NUM_MODES] = {
   ...
   // MODE_GROUP_FIFTH
   {{{CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_MIN7B5},  7, SCALE_IONIAN},
   {{CHORD_POWER5,  CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_MIN7B5,  CHORD_POWER5}, 7, SCALE_DORIAN},
   {{CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_MIN7B5,  CHORD_POWER5,  CHORD_POWER5, }, 7, SCALE_PHRYGIAN},
   {{CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_MIN7B5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5}, 7, SCALE_LYDIAN},
   {{CHORD_POWER5,  CHORD_POWER5,  CHORD_MIN7B5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5, CHORD_POWER5}, 7, SCALE_MIXOLYDIAN},
   {{CHORD_POWER5,  CHORD_MIN7B5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5}, 7, SCALE_AEOLIAN},
   {{CHORD_MIN7B5,  CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5, CHORD_POWER5,  CHORD_POWER5,  CHORD_POWER5}, 7, SCALE_LOCRIAN}},
  // MODE_GROUP_SEVENTH
